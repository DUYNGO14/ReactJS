...
const Header = () => {
  ...
  return (
    <>
      <nav
        className={`bg-white pb-5 md:text-sm border-b-[1px] border-indigo-200 ${
          state
        ...
        <Box className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
          <Box className="flex items-center justify-between py-5 md:block">
            <Link to="/" className="text-2xl font-bold text-gray-800">
              <img src="https://www.pngkey.com/png/full/64-643451_manchester-united-logo-png.png" alt=""  className="w-full max-w-[50px] h-full rounded-full max-sm" />
            </Link>
